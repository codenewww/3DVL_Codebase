...
# more dataset
SCANVQA_MORE = []
SCANVQA_MORE += json.load(open(os.path.join(CONF.PATH.DATA, "ScanVQA/ScanVQA_generated.json")))
SCANVQA_MORE += json.load(open(os.path.join(CONF.PATH.DATA, "ScanVQA/ScanRefer_filtered_generated.json")))
SCANVQA_MORE += json.load(open(os.path.join(CONF.PATH.DATA, "ScanVQA/nr3d_generated.json")))
# template-based; dataset-size x 2
SCANVQA_MASK = []
SCANVQA_MASK += SCANVQA_TRAIN
SCANVQA_MASK += json.load(open(os.path.join(CONF.PATH.DATA, "ScanVQA/ScanVQA_generated.json")))
SCANVQA_MASK += json.load(open(os.path.join(CONF.PATH.DATA, "ScanVQA/ScanRefer_filtered_generated_masked.json")))
SCANVQA_MASK += json.load(open(os.path.join(CONF.PATH.DATA, "ScanVQA/nr3d_generated_masked.json")))

# split via scene id
# validation dataset
SCANVQA_VAL = json.load(open(os.path.join(CONF.PATH.DATA, "ScanVQA/ScanVQA_filter_v3.0.json")))

SCANVQA_ANSWER_LIST = []  # calculate during training
